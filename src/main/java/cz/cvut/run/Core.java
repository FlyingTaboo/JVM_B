...
public class Core {
	...
	public static StackElement invokeCoreMethod(String clazzName, String methodName, StackElement[] locals, Stack<StackElement> stack, ArrayList<ConstantPoolElement> constantPool) {
		log.debug("Invoked core method: " + clazzName + " " + methodName + " " + Arrays.toString(locals) + " " + stack);
		if (clazzName.equals("java/lang/String")){
			return invokeString(clazzName, methodName, locals, stack, constantPool);
			...
			return invokePrintStream(methodName, locals, stack, constantPool);
		}
		return null;
	}


	private static StackElement invokePrintStream(String methodName, StackElement[] locals, Stack<StackElement> stack,
	...
	private static StackElement invokeString(String clazzName, String methodName, StackElement[] locals, Stack<StackElement> stack, ArrayList<ConstantPoolElement> constantPool) {
